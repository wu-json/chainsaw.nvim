...
local theme = lush(function(injected_functions)
	...
	return {
		...
		FloatBorder({ fg = palette.gray_muted }), -- Border of floating windows.
		...
		Question({ fg = palette.blue }), -- |hit-enter| prompt and yes/no questions
		QuickFixLine({ fg = palette.blue }), -- Current |quickfix| item in the quickfix window. Combined with |hl-CursorLine| when the cursor is there.
		...
		StatusLine({ bg = palette.black }), -- Status line of current window
		...
		TabLineSel({ fg = palette.blue, bg = "NONE", gui = "bold" }), -- Tab pages line, active tab page label
		...
		-- Operator       { }, --   "sizeof", "+", "*", etc.
		Keyword({ fg = palette.gray, gui = "bold" }), --   any other keyword (async, await, etc.)
		...
		StorageClass({ fg = palette.gray, gui = "bold" }), --   static, register, volatile, etc. (const, let, var)
		-- Structure      { }, --   struct, union, enum, etc.
		-- Typedef        { }, --   A typedef

		Special({ fg = palette.blue }), -- (*) Any special symbol
		-- SpecialChar({ fg = palette.blue }), --   Special character in a constant
		-- Tag({ fg = palette.blue }), --   You can use CTRL-] on this
		-- Delimiter      { }, --   Character that needs attention
		-- SpecialComment({ fg = palette.blue }), --   Special things inside a comment (e.g. '\n')
		-- Debug({ fg = palette.blue }), --   Debugging statements
		...
		sym("@function.macro")({ fg = palette.blue }), -- Macro
		-- sym"@parameter"         { }, -- Identifier
		-- sym"@method"            { }, -- Function
		sym("@field")({ fg = palette.gray }), -- Field (object fields, etc.)
		sym("@property")({ fg = palette.gray }), -- Property (object properties, etc.)
		-- sym"@constructor"       { }, -- Special
		-- sym"@conditional"       { }, -- Conditional
		-- sym"@repeat"            { }, -- Repeat
		-- sym"@label"             { }, -- Label
		-- sym"@operator"          { }, -- Operator
		sym("@keyword")({ fg = palette.gray }), -- Keyword (async, await, etc.)
		-- sym"@exception"         { }, -- Exception
		-- sym"@variable"          { }, -- Identifier
		-- sym"@type"              { }, -- Type
		-- sym"@type.definition"   { }, -- Typedef
		sym("@storageclass")({ fg = palette.gray, gui = "bold" }), -- StorageClass (const, let, var)
